...
export default function ContactForm() {
  ...
  return (
    <section className="py-20 px-4 flex justify-center">
      <div className="w-full max-w-2xl bg-white border border-green-200 p-8 rounded-3xl shadow-lg">
        <h2 className="text-3xl font-bold mb-6 text-center text-gray-900">Get Your <span className="text-green-600">Quote</span></h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <input 
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-lg p-4 focus:border-green-600 focus:outline-none transition text-gray-900"
            />
            <input 
