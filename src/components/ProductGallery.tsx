      ...
      <div className="max-w-7xl mx-auto">
          ...
          <AnimatePresence>
            {filteredImages.map((img) => (
              ...
              >
                ...
                <div className={`w-full h-full bg-green-50 flex items-center justify-center group-hover:scale-110 transition duration-700`}>
                    <span className="text-gray-400">Image: {img.title}</span>
                </div>
        ...
        <AnimatePresence>
          {selectedImage && (
            ...
            >
              <button className="absolute top-6 right-6 text-gray-300 hover:text-green-500">
                <X size={40} />
              </button>
              ...
              >
                 <div className="h-[60vh] bg-gray-100 flex items-center justify-center">
                    <span className="text-2xl text-gray-400 font-bold">[Full High-Res Image of {selectedImage.title}]</span>
                 </div>
                 <div className="p-8">
                    ...
                    <button className="mt-6 bg-green-600 text-white px-8 py-3 rounded-full font-bold hover:bg-green-700 transition w-full md:w-auto">
