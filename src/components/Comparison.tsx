  ...
  return (
    <section className="py-20 px-4 md:px-20 bg-green-50">
      <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">
        The Right <span className="text-green-600">Choice</span>
      </h2>
      
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse min-w-[600px]">
          <thead>
            <tr className="border-b border-green-300 text-lg">
              <th className="p-4 text-green-700 font-bold uppercase tracking-wider">Feature</th>
          ...
          >
            {[
              ...
              <motion.tr 
                ...
                className="border-b border-green-200 hover:bg-green-100/50 transition"
              >
